...
export default function Sidebar() {
  ...
  return (
    <div className={`hidden md:flex h-screen flex-col border-r border-gray-100 bg-white transition-all duration-300 ease-in-out ${
      isOpen ? 'w-64' : 'w-16'
    }`}>
      {/* Header */}
        ...
        {menuItems.map((item) => {
          ...
          if (isDisabled) {
            return (
              <div
                key={item.name}
                className={`flex items-center rounded-lg text-sm text-gray-400 cursor-not-allowed transition-all ${
